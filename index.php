...
<body>  
    ...
    <section class="featured_posts">
        <div class="post">    
            ...
            <h2>Cooking for your dog? Watch out for the nutrient deficiencies</h2> <!-- Import DB Title -->
    ...
    <section class="latest_posts">
        <div class="post">
            ...
            <div class="tags">
                ...
                <h2>The 11 dogs food label tricks every owner need to know</h2> <!-- Import DB Title -->
